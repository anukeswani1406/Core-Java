/*
Anu Keswani ---> Slip No 3
Write a java program to accept the details of ‘n’ employees (EName ,Salary) from
the user, store them into the Hashtable and displays the Employee Names havin maximum
Salary.
*/
